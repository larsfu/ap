...
\fig{content/bilder/13}{Endliche $LC$-Kette mit Abschlusswiderstand, aus \cite{anleitung356}.}{awid}
\fig{content/bilder/14}{Frequenzabhängigkeit der charakteristischen Impedanz einer $LC$-Kette, aus \cite{anleitung356}.}{freqab}
...
\fig{content/bilder/14}{Abschluss einer endlich langen $LC$-Kette mit einem (komplexen) Widerstand $Z$, aus \cite{anleitung356}.}{freqab}
